    ...
    return (
        <div className="flex flex-col flex-1">
            <div className="flex-1 p-6 space-y-6">
                ...
                <div>
                     <h1 className="text-2xl font-bold font-headline text-primary-foreground">Security Intelligence Dashboard</h1>
                     <p className="text-muted-foreground">Real-time risk assessment and security posture analysis</p>
                </div>
            ...
            {/* Bottom Status Bar */}
            <footer className="mt-auto border-t border-border bg-card p-4 flex items-center justify-between">
